...
import 'putrace_oauth_service.dart';
import 'putrace_crypto_service.dart';

class PutraceContactsService {
  final PutraceOauthService _oauth;
  final PutraceCryptoService _crypto;
  PutraceContactsService(this._oauth, this._crypto);
