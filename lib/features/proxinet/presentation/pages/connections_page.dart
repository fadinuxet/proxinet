...
class _ConnectionsPageState extends State<ConnectionsPage>
  ...
  final FirebasePostsRepo _firebaseRepo = GetIt.instance<FirebasePostsRepo>();
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      print('Error loading connections data: $e');
  ...
  void _sendConnectionRequest(UserProfile suggestion) async {
    try {
      await _connectionService.sendConnectionRequest(
        ...
        message: 'Hi! I\'d like to connect with you on Proxinet.',
