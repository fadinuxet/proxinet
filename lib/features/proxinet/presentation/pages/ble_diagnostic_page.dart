...
import '../../../../core/services/proxinet_ble_constants.dart';
...
class _BleDiagnosticPageState extends State<BleDiagnosticPage> {
  ...
  final _bleService = GetIt.instance<ProxinetBleService>();
  ...
  Widget _buildControlPanel() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border(
          bottom: BorderSide(color: _colorScheme.outline.withOpacity(0.2)),
        ),
      ),
      child: Column(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ProxinetBleConstants.serviceUuid,
                                     style: TextStyle(
                     fontSize: 12,
                     fontFamily: 'Courier',
