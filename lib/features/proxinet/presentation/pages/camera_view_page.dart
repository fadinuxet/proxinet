          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Event Mode uses Bluetooth Low Energy (BLE) to discover other Proxinet users nearby. This is perfect for:\n\n'
                  '• Networking events and conferences\n'
                  '• Meetups and social gatherings\n'
                  '• Finding colleagues at work\n'
                  '• Discovering people with similar interests\n\n'
                  'Your device will broadcast a temporary identifier that other users can discover, and you\'ll see nearby Proxinet users in real-time.',
                  style: TextStyle(
                    fontSize: 14,
                      ...
                      Expanded(
                        child: Text(
                          _running
                              ...
                              : 'Click Start to begin discovering nearby Proxinet users',
                          style: TextStyle(
                            fontSize: 12,
                            color: scheme.onSurfaceVariant,
                          ),
