...
class _AvailabilityPageState extends State<AvailabilityPage> {
  ...
  late final PutracePresenceSyncService _presenceSync;
      ...
      child: Column(
        ...
        children: [
          ...
          _buildGuidelineItem(
            ...
            onAction: () => context.push('/putrace/nearby'),
            scheme: scheme,
          ),
          const SizedBox(height: 12),
          _buildGuidelineItem(
            ...
            action: 'Open Map',
            onAction: () => context.push('/putrace/map'),
            scheme: scheme,
          ),
          const SizedBox(height: 12),
          _buildGuidelineItem(
            ...
            onAction: () => context.push('/putrace/messages'),
            scheme: scheme,
          ),
          const SizedBox(height: 12),
          _buildGuidelineItem(
            ...
            onAction: () => context.push('/putrace/groups'),
            scheme: scheme,
          ),
          const SizedBox(height: 12),
          _buildGuidelineItem(
            ...
            onAction: () => context.push('/putrace/available-people'),
            scheme: scheme,
          ),
          const SizedBox(height: 16),
          Container(
