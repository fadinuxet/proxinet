...
class PutraceOnboardingPage extends StatefulWidget {
  const PutraceOnboardingPage({super.key});

  @override
  State<PutraceOnboardingPage> createState() => _PutraceOnboardingPageState();
}

class _PutraceOnboardingPageState extends State<PutraceOnboardingPage> {
