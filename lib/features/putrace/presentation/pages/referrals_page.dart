...
class _ReferralsPageState extends State<ReferralsPage> {
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Share Putrace with friends and earn credits for each successful referral!',
  ...
  Future<void> _generateAndShareInvite() async {
    try {
      ...
      final inviteUrl = 'https://putrace.app/invite/$referralCode';
      ...
      try {
        await Share.share(
          'Join me on Putrace - the privacy-first proximity networking app! '
          'Use my invite link: $inviteUrl\n\n'
          'Or use my referral code: $referralCode',
          subject: 'Join Putrace with me!',
        );
